...
parser.add_argument("--task", type=str, choices=("MS3", "S4"), default="S4")
parser.add_argument("--encoder", type=str, choices=("pvt", "resnet", "swin"), default="pvt")
...
cfg.TRAIN.PasREPROCESS_AUDIO_TO_LOG_MEL = False
...
cfg.TRAIN.PRETRAINED_PVTV2_PATH = "/mnt/SSD/avs_bidirectional_generation/SeqMotionAVS/pretrained_backbones/pvt_v2_b5.pth"
...
cfg.MODEL.DECODER = "simple"
cfg.MODEL.FUSION = "av_corr"  # av_corr, tpavi
...
# PARAM
cfg.PARAM = edict()
cfg.PARAM.BATCH_SIZE = 12
cfg.PARAM.NUM_WORKERS = 20
