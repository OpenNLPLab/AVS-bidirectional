...
class AVCorr(nn.Module):
    def __init__(self, in_channels):
        ...
        self.conv1 = BasicConv2d(self.in_channels, self.in_channels//4, 1, norm=False, act=False)
        self.conv2 = BasicConv2d(self.in_channels//4, self.in_channels//4, 7, padding=3, norm=False, act=False)
        # self.conv2 = BasicConv2d(self.in_channels//4, self.in_channels//4, 3, padding=1, norm=False, act=False)
        self.conv3 = BasicConv2d(self.in_channels//4, 1, 1, norm=False, act=False)
    ...
    def forward(self, visual, audio):
        ...
        atten_map = torch.sigmoid(self.conv3(self.conv2(self.conv1(corr))))
        visual_atten = visual * atten_map
